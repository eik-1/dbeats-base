import {
  NewNFT as NewNFTEvent,
  RoleGranted as RoleGrantedEvent,
} from "../generated/DBeatsFactory/DBeatsFactory";
import { BigInt, Bytes } from "@graphprotocol/graph-ts";

import { Artist, Factory, NFT, RoleGranted } from "../generated/schema";

const FACTORY_ADDRESS = "0x6c9884fA54bc935050839aD2dA1AC3d08fe71e11";
const ARTIST_ROLE = Bytes.fromHexString(
  "0x93fac2f6eba5c6ab0b78b0deca04c08b0e1c2a933a605c0fa3ce64da8fc04115"
);
...
export function handleNewNFT(event: NewNFTEvent): void {
  ...
  nft.maxMintLimit = event.params.maxMintLimit;
